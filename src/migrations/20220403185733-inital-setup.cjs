...
const tableNames = ['user', 'semPoint'];

module.exports = {
  up: async (queryInterface) => {
    await queryInterface.sequelize.query(`
      CREATE TYPE enum_user_gender AS ENUM ('Male', 'Female', 'Other');
      CREATE TYPE enum_semPoint_proficiency AS ENUM ('Beginer', 'Intermediate', 'Advanced');
      ...
      CREATE TABLE IF NOT EXISTS public.semPoint
      (
          id serial NOT NULL,
          user_id integer NOT NULL,
          name character varying(255) COLLATE pg_catalog."default" NOT NULL,
          proficiency enum_semPoint_proficiency,
          created_at timestamp with time zone,
          updated_at timestamp with time zone,
          CONSTRAINT semPoint_pkey PRIMARY KEY (id),
          CONSTRAINT "semPoint_user_id_fkey" FOREIGN KEY (user_id)
